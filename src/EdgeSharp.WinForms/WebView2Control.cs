...
namespace EdgeSharp.WinForms
{
    public partial class WebView2Control : WebView2, IWebView2
    {
        ...
        public virtual async void InitializeAsync()
        {
            try
            {
                Dispatcher.Browser = new BrowserDispatcher(this);
                ...
                CoreWebView2.Settings.IsScriptEnabled = creationOption.IsScriptEnabled;
                CoreWebView2.Settings.IsWebMessageEnabled = creationOption.IsWebMessageEnabled;
                CoreWebView2.Settings.IsZoomControlEnabled = creationOption.IsZoomControlEnabled;
                CoreWebView2.Settings.IsBuiltInErrorPageEnabled = creationOption.IsBuiltInErrorPageEnabled;
                CoreWebView2.Settings.IsStatusBarEnabled = creationOption.IsStatusBarEnabled;

                CoreWebView2.Settings.AreDefaultScriptDialogsEnabled = creationOption.AreDefaultScriptDialogsEnabled;
                CoreWebView2.Settings.AreDevToolsEnabled = creationOption.AreDevToolsEnabled;
                CoreWebView2.Settings.AreDefaultContextMenusEnabled = creationOption.AreDefaultContextMenusEnabled;
                CoreWebView2.Settings.AreHostObjectsAllowed = creationOption.AreHostObjectsAllowed;

                try
                {
                    // If not added yet
                    CoreWebView2.Settings.AreBrowserAcceleratorKeysEnabled = creationOption.AreBrowserAcceleratorKeysEnabled;
                }
                catch { }
                ...
                {
                    CoreWebView2.Settings.UserAgent = creationOption.UserAgent;
                }
